...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '0cde9779-8b67-11ef-b09a-0242ac130002:1-22227804';

--
-- Table structure for table `pha_drug_master`
--

DROP TABLE IF EXISTS `pha_drug_master`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `pha_drug_master` (
  ...
  `ROUTE` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ATC_CODE` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `NDC_CODE` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `MANUFACTURER` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `THERAPEUTIC_CLASS` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `CONTROLLED_SUBSTANCE` tinyint(1) DEFAULT '0',
  `DEA_SCHEDULE` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `INTERACTIONS` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `PREGNANCY_CATEGORY` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `pha_drug_master`
--

LOCK TABLES `pha_drug_master` WRITE;
/*!40000 ALTER TABLE `pha_drug_master` DISABLE KEYS */;
/*!40000 ALTER TABLE `pha_drug_master` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-05-22 22:20:20
