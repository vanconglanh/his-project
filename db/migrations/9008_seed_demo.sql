...
VALUES
    ('70000001-0000-0000-0000-000000000001', 1, 'e0000001-0000-0000-0000-000000000001', 'f0000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000002', 'RX-2025-00001', 'DISPENSED', 'E11.9', DATE_SUB(NOW(), INTERVAL 30 DAY), DATE_SUB(NOW(), INTERVAL 30 DAY)),
    ('70000001-0000-0000-0000-000000000002', 1, 'e0000001-0000-0000-0000-000000000002', 'f0000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000002', 'RX-2025-00002', 'DISPENSED', 'E11.9', DATE_SUB(NOW(), INTERVAL 7 DAY), DATE_SUB(NOW(), INTERVAL 7 DAY)),
    ('70000001-0000-0000-0000-000000000003', 1, 'e0000001-0000-0000-0000-000000000003', 'f0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000002', 'RX-2025-00003', 'DISPENSED', 'I10',   DATE_SUB(NOW(), INTERVAL 25 DAY), DATE_SUB(NOW(), INTERVAL 25 DAY)),
    ('70000001-0000-0000-0000-000000000004', 1, 'e0000001-0000-0000-0000-000000000004', 'f0000000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000002', 'RX-2025-00004', 'DISPENSED', 'E78.5', DATE_SUB(NOW(), INTERVAL 22 DAY), DATE_SUB(NOW(), INTERVAL 22 DAY)),
    ('70000001-0000-0000-0000-000000000005', 1, 'e0000001-0000-0000-0000-000000000006', 'f0000000-0000-0000-0000-000000000005', 'a0000000-0000-0000-0000-000000000002', 'RX-2025-00005', 'DISPENSED', 'I11.9', DATE_SUB(NOW(), INTERVAL 18 DAY), DATE_SUB(NOW(), INTERVAL 18 DAY)),
    ('70000001-0000-0000-0000-000000000006', 1, 'e0000001-0000-0000-0000-000000000008', 'f0000000-0000-0000-0000-000000000007', 'a0000000-0000-0000-0000-000000000002', 'RX-2025-00006', 'DISPENSED', 'E11.4', DATE_SUB(NOW(), INTERVAL 12 DAY), DATE_SUB(NOW(), INTERVAL 12 DAY)),
    ('70000001-0000-0000-0000-000000000007', 1, 'e0000001-0000-0000-0000-000000000009', 'f0000000-0000-0000-0000-000000000008', 'a0000000-0000-0000-0000-000000000002', 'RX-2025-00007', 'DISPENSED', 'K29.7', DATE_SUB(NOW(), INTERVAL 10 DAY), DATE_SUB(NOW(), INTERVAL 10 DAY)),
    ('70000001-0000-0000-0000-000000000008', 1, 'e0000001-0000-0000-0000-000000000011', 'f0000000-0000-0000-0000-000000000010', 'a0000000-0000-0000-0000-000000000002', 'RX-2025-00008', 'DISPENSED', 'I10',   DATE_SUB(NOW(), INTERVAL 6 DAY), DATE_SUB(NOW(), INTERVAL 6 DAY)),
    ('70000001-0000-0000-0000-000000000009', 1, 'e0000001-0000-0000-0000-000000000014', 'f0000000-0000-0000-0000-000000000005', 'a0000000-0000-0000-0000-000000000002', 'RX-2025-00009', 'SIGNED',    'I50',   DATE_SUB(NOW(), INTERVAL 3 DAY), DATE_SUB(NOW(), INTERVAL 3 DAY)),
    ('70000001-0000-0000-0000-000000000010', 1, 'e0000001-0000-0000-0000-000000000015', 'f0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000002', 'RX-2025-00010', 'SIGNED',    'I10',   DATE_SUB(NOW(), INTERVAL 2 DAY), DATE_SUB(NOW(), INTERVAL 2 DAY));
...
VALUES
    (UUID(), 1, '70000001-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000001', '1 viên x 2 lần/ngày sau ăn', '2 lần/ngày', 'ORAL', 30, 60,  'Dùng sau bữa ăn sáng và tối', NOW()),
    (UUID(), 1, '70000001-0000-0000-0000-000000000002', 'd0000000-0000-0000-0000-000000000001', '1 viên x 2 lần/ngày sau ăn', '2 lần/ngày', 'ORAL', 30, 60,  'Dùng sau bữa ăn', NOW()),
    (UUID(), 1, '70000001-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000002', '1 viên/ngày buổi sáng',       '1 lần/ngày', 'ORAL', 30, 30,  'Dùng buổi sáng sau ăn', NOW()),
    (UUID(), 1, '70000001-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000003', '1 viên/ngày buổi tối',        '1 lần/ngày', 'ORAL', 30, 30,  'Dùng buổi tối', NOW()),
    (UUID(), 1, '70000001-0000-0000-0000-000000000005', 'd0000000-0000-0000-0000-000000000002', '1 viên/ngày',                 '1 lần/ngày', 'ORAL', 30, 30,  NULL, NOW()),
    (UUID(), 1, '70000001-0000-0000-0000-000000000006', 'd0000000-0000-0000-0000-000000000001', '1 viên x 2 lần/ngày',         '2 lần/ngày', 'ORAL', 30, 60,  NULL, NOW()),
    (UUID(), 1, '70000001-0000-0000-0000-000000000007', 'd0000000-0000-0000-0000-000000000005', '1 viên/ngày trước ăn 30p',    '1 lần/ngày', 'ORAL', 30, 30,  'Uống trước bữa sáng 30 phút', NOW()),
    (UUID(), 1, '70000001-0000-0000-0000-000000000008', 'd0000000-0000-0000-0000-000000000002', '1 viên/ngày',                 '1 lần/ngày', 'ORAL', 30, 30,  NULL, NOW()),
    (UUID(), 1, '70000001-0000-0000-0000-000000000009', 'd0000000-0000-0000-0000-000000000002', '1 viên/ngày',                 '1 lần/ngày', 'ORAL', 30, 30,  NULL, NOW()),
    (UUID(), 1, '70000001-0000-0000-0000-000000000010', 'd0000000-0000-0000-0000-000000000002', '1 viên/ngày',                 '1 lần/ngày', 'ORAL', 30, 30,  NULL, NOW());
