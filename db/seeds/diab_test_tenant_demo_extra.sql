...
--    Dải UUID: a6000000-0000-0000-0000-000000000001..
-- ================================================================
...
('a6000000-0000-0000-0000-000000000001', 2,
...
('a6000000-0000-0000-0000-000000000003', 2,
...
('a6000000-0000-0000-0000-000000000004', 2,
...
('a6000000-0000-0000-0000-000000000005', 2,
...
('a6000000-0000-0000-0000-000000000006', 2,
...
('a6000000-0000-0000-0000-000000000007', 2,
...
('a6000000-0000-0000-0000-000000000008', 2,
...
INSERT IGNORE INTO `pha_prescriptions`
    (`id`, `tenant_id`, `encounter_id`, `patient_id`, `doctor_id`,
     ...
     `signed_at`, `dispensed_at`, `created_by`)
VALUES
('a9000000-0000-0000-0000-000000000002', 2,
...
INSERT IGNORE INTO `pha_prescriptions`
    (`id`, `tenant_id`, `encounter_id`, `patient_id`, `doctor_id`,
     ...
     `signed_at`, `dispensed_at`, `created_by`)
VALUES
('a9000000-0000-0000-0000-000000000003', 2,
...
INSERT IGNORE INTO `pha_prescription_items`
    (`id`, `tenant_id`, `prescription_id`, `drug_id`,
     `dosage`, `frequency`, `route`, `duration_days`, `quantity`, `instructions`, `created_by`)
VALUES
('a8000000-0000-0000-0000-000000000005', 2,
...
INSERT IGNORE INTO `pha_prescriptions`
    (`id`, `tenant_id`, `encounter_id`, `patient_id`, `doctor_id`,
     ...
     `signed_at`, `dispensed_at`, `created_by`)
VALUES
('a9000000-0000-0000-0000-000000000004', 2,
...
INSERT IGNORE INTO `pha_prescription_items`
    (`id`, `tenant_id`, `prescription_id`, `drug_id`,
     `dosage`, `frequency`, `route`, `duration_days`, `quantity`, `instructions`, `created_by`)
VALUES
('a8000000-0000-0000-0000-000000000006', 2,
...
('a8000000-0000-0000-0000-000000000007', 2,
 'a9000000-0000-0000-0000-000000000004',
 'd2000000-0000-0000-0000-000000000001',
...
INSERT IGNORE INTO `pha_prescriptions`
    (`id`, `tenant_id`, `encounter_id`, `patient_id`, `doctor_id`,
     ...
     `signed_at`, `dispensed_at`, `created_by`)
VALUES
('a9000000-0000-0000-0000-000000000005', 2,
...
INSERT IGNORE INTO `pha_prescription_items`
    (`id`, `tenant_id`, `prescription_id`, `drug_id`,
     `dosage`, `frequency`, `route`, `duration_days`, `quantity`, `instructions`, `created_by`)
VALUES
('a8000000-0000-0000-0000-000000000008', 2,
...
VALUES
('b4000000-0000-0000-0000-000000000001', 2,
 'f2000000-0000-0000-0000-000000000003',
 'e2000000-0000-0000-0000-000000000002',
...
VALUES
('b2000000-0000-0000-0000-000000000001', 2,
...
INSERT IGNORE INTO `diab_his_bil_billing`
    (`id`, `tenant_id`, `patient_id`, `encounter_id`, `bill_no`,
     ...
     `status`, `finalized_at`, `created_by`)
VALUES
('b4000000-0000-0000-0000-000000000002', 2,
 'f2000000-0000-0000-0000-000000000004',
 'e2000000-0000-0000-0000-000000000008',
...
INSERT IGNORE INTO `diab_his_bil_payments`
    (`id`, `tenant_id`, `billing_id`, `amount`, `method`,
     `status`, `paid_at`, `paid_by`)
VALUES
('b2000000-0000-0000-0000-000000000002', 2,
...
INSERT IGNORE INTO `diab_his_bil_billing`
    (`id`, `tenant_id`, `patient_id`, `encounter_id`, `bill_no`,
     ...
     `status`, `finalized_at`, `created_by`)
VALUES
('b4000000-0000-0000-0000-000000000003', 2,
 'f2000000-0000-0000-0000-000000000005',
...
INSERT IGNORE INTO `diab_his_bil_billing`
    (`id`, `tenant_id`, `patient_id`, `encounter_id`, `bill_no`,
     ...
     `status`, `finalized_at`, `created_by`)
VALUES
('b4000000-0000-0000-0000-000000000004', 2,
 'f2000000-0000-0000-0000-000000000018',
 'e2000000-0000-0000-0000-000000000005',
...
INSERT IGNORE INTO `diab_his_bil_billing`
    (`id`, `tenant_id`, `patient_id`, `encounter_id`, `bill_no`,
     ...
     `status`, `finalized_at`, `created_by`)
VALUES
('b4000000-0000-0000-0000-000000000005', 2,
 'f2000000-0000-0000-0000-000000000024',
 'e2000000-0000-0000-0000-000000000009',
...
('a3000000-0000-0000-0000-000000000001', 2,
 'e2000000-0000-0000-0000-000000000003',
...
('a3000000-0000-0000-0000-000000000002', 2,
...
('a3000000-0000-0000-0000-000000000003', 2,
 'e2000000-0000-0000-0000-000000000007',
...
('a3000000-0000-0000-0000-000000000004', 2,
 'e2000000-0000-0000-0000-000000000006',
 'HBA1C', N'HbA1c (Glycated Hemoglobin)',
...
('a3000000-0000-0000-0000-000000000005', 2,
 'e2000000-0000-0000-0000-000000000005',
 'HBA1C', N'HbA1c (Glycated Hemoglobin)',
 N'Máu tĩnh mạch', 'NORMAL', 'done',
...
('a3000000-0000-0000-0000-000000000006', 2,
...
VALUES
('a4000000-0000-0000-0000-000000000001', 2,
...
INSERT IGNORE INTO `diab_his_pkg_subscriptions`
    (`id`, `tenant_id`, `patient_id`, `package_id`,
     ...
     `payment_status`, `status`, `activated_at`, `created_by`)
VALUES
('a5000000-0000-0000-0000-000000000002', 2,
...
('a7000000-0000-0000-0000-000000000001', 2,
 'f2000000-0000-0000-0000-000000000019',
 'OVERDUE_HBA1C',
...
('a7000000-0000-0000-0000-000000000002', 2,
...
('a7000000-0000-0000-0000-000000000003', 2,
 'f2000000-0000-0000-0000-000000000021',
 'OVERDUE_VISIT',
 DATE_ADD(@today, INTERVAL 7 DAY),
 CONCAT('{"trigger":"subscription_expiry","subscription_id":"a5000000-0000-0000-0000-000000000001","expiry_date":"', DATE_FORMAT(DATE_ADD(@today, INTERVAL 10 DAY), '%Y-%m-%d'), '"}'),
 'HIGH', 'PENDING', 'PHONE',
 N'Gói dịch vụ sắp hết hạn trong 10 ngày — tư vấn gia hạn',
 NOW()),

-- RC04: BNT00024 — vừa chẩn đoán ĐTĐ, nhắc đo HbA1c sau 3 tháng
('a7000000-0000-0000-0000-000000000004', 2,
 'f2000000-0000-0000-0000-000000000024',
 'OVERDUE_HBA1C',
...
('a7000000-0000-0000-0000-000000000005', 2,
 'f2000000-0000-0000-0000-000000000020',
 'OVERDUE_VISIT',
